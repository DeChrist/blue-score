...
On pushes to `main`, the workflow then runs a `release` job after `deploy`, that creates and pushes a semantic versioning compliant `vX.Y.Z` tag and publishes a GitHub Release with generated notes:
